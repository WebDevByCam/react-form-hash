  ...
  return (
    <>
      ...
      <div className="social-login">
        ...
        <button type="button" className="social-btn linkedin" aria-label="Sign in with LinkedIn">
          <FaLinkedin />
        </button>
        <button type="button" className="social-btn authy" aria-label="Sign in with Authy">
          <FaShieldAlt />
        </button>
      </div>
